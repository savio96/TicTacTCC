  ...
  <div>
    ...
    <Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Passo 5</h3>
          <p>Clique em "Adicionar extensão" e ela irá ser adicionada ao seu Chrome</p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Passo 6</h3>
          <p>Vá no seu gerenciamento de extensões e clique em "Kepper Wallet"</p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Passo 8</h3>
          <p>Crie uma senha que será armazenada localmente, aceite os termos e clique em "Continuar"</p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Passo 9</h3>
          <p>Clique em "Criar uma conta nova", escolha um avatar e clique em "Continuar"</p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Passo 10</h3>
          <p>Salve de uma forma segura sua cadeia de palavras aleatórias, clique em "Continuar". Na próxima tela, selecione sua senha na ordem correta e clique em "Confirmar"</p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Passo 11</h3>
          <p>Crie um nome da conta, clique em "Continuar" e finalize o processo.</p>
        </Carousel.Caption>
      </Carousel.Item>
